...
const Select  = () => {
    ...
    return (
      <div className='relative'>
        {/* dropdown - btn */}
        <div onClick={() => setIsOpen(!isOpen)} className="mx-auto flex items-center justify-between rounded-xl bg-white cursor-pointer">
        ...
        {/* dropdown - options  */}
        <div className={`${isOpen ? 'absolute top-4 opacity-100' : 'absolute top-10 opacity-0'} mx-auto my-4 rounded-xl py-4 border duration-300 bg-black w-full`}>
