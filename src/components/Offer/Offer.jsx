...
const Offer = () => {
  ...
  return (
    <Container>
      <div className="mx-6 md:mx-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {/* card 1 */}
          ...
          <div key={index} className="relative bg-[#a0e1e1] rounded-[2rem] p-4 md:p-8 flex-1 max-w-[650px] w-full">
            <div className="space-y-1.5 flex gap-4 flex-1 flex-col justify-between md:min-h-[17rem] w-full">
              <div className="flex-1 flex justify-center flex-col">
                ...
                <p className="text-lg font-semibold text-gray-700 flex gap-2 items-center uppercase">
